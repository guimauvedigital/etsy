 ...
 * @param listing An enumerated string that attaches a valid association. Default value is null.
 */
@Serializable

data class ListingInventoryWithAssociations (

    /* A JSON array of products available in a listing, even if only one product. All field names in the JSON blobs are lowercase. */
    @SerialName(value = "products") val products: kotlin.collections.List<ListingInventoryProduct>? = null,
    ...
    @SerialName(value = "listing") val listing: ShopListing? = null
