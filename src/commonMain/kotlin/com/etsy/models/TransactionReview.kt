 ...
 * @param transactionId The ID of the ShopReceipt Transaction that the TransactionReview belongs to.
 * @param buyerUserId The numeric ID of the user who was the buyer in this transaction. Note: This field may be absent, depending on the buyer's privacy settings.
...
data class TransactionReview (
    ...
    @SerialName(value = "review") val review: kotlin.String? = "",
