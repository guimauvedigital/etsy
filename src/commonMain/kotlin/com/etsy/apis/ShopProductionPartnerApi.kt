...
open class ShopProductionPartnerApi : ApiClient {
    ...
    open suspend fun getShopProductionPartners(shopId: kotlin.Long): HttpResponse<ShopProductionPartners> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v3/application/shops/{shop_id}/production-partners".replace("{" + "shop_id" + "}", "$shopId"),
