...
open class UserAddressApi : ApiClient {
     ...
     * @return void
     */
    open suspend fun deleteUserAddress(userAddressId: kotlin.Long): HttpResponse<Unit> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            ...
            "/v3/application/user/addresses/{user_address_id}".replace("{" + "user_address_id" + "}", "$userAddressId"),
    ...
    open suspend fun getUserAddress(userAddressId: kotlin.Long): HttpResponse<UserAddress> {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getUserAddresses(limit: kotlin.Int? = 25, offset: kotlin.Int? = 0): HttpResponse<UserAddresses> {
