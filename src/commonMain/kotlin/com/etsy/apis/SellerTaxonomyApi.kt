...
open class SellerTaxonomyApi : ApiClient {
    ...
    open suspend fun getPropertiesByTaxonomyId(taxonomyId: kotlin.Long): HttpResponse<TaxonomyNodeProperties> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v3/application/seller-taxonomy/nodes/{taxonomy_id}/properties".replace("{" + "taxonomy_id" + "}", "$taxonomyId"),
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getSellerTaxonomyNodes(): HttpResponse<SellerTaxonomyNodes> {
