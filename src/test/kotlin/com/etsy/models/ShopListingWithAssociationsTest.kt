...
class ShopListingWithAssociationsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ShopListingWithAssociations
        //val modelInstance = ShopListingWithAssociations()
        ...
        // to test the property `shippingProfile` - An array of data representing the shipping profile resource.
        should("test shippingProfile") {
            // uncomment below to test the property
            //modelInstance.shippingProfile shouldBe ("TODO")
        }

        // to test the property `user` - Represents a single user of the site
        should("test user") {
            // uncomment below to test the property
            //modelInstance.user shouldBe ("TODO")
        }

        // to test the property `shop` - A shop created by an Etsy user.
        should("test shop") {
            // uncomment below to test the property
            //modelInstance.shop shouldBe ("TODO")
        }

        // to test the property `images` - Represents a list of listing image resources, each of which contains the reference URLs and metadata for an image
        should("test images") {
            // uncomment below to test the property
            //modelInstance.images shouldBe ("TODO")
        }

        // to test the property `videos` - The single video associated with a listing.
        should("test videos") {
            // uncomment below to test the property
            //modelInstance.videos shouldBe ("TODO")
        }

        // to test the property `inventory` - An enumerated string that attaches a valid association. Default value is null.
        should("test inventory") {
            // uncomment below to test the property
            //modelInstance.inventory shouldBe ("TODO")
        }

        // to test the property `productionPartners` - Represents a list of production partners for a shop.
        should("test productionPartners") {
            // uncomment below to test the property
            //modelInstance.productionPartners shouldBe ("TODO")
        }

        // to test the property `skus` - A list of SKU strings for the listing. SKUs will only appear if the requesting user owns the shop and a valid matching OAuth 2 token is provided. When requested without the token it will be an empty array.
        should("test skus") {
            // uncomment below to test the property
            //modelInstance.skus shouldBe ("TODO")
        }

        // to test the property `translations` - A map of translations for the listing. Default value is a map of all supported languages keyed to null.
        should("test translations") {
            // uncomment below to test the property
            //modelInstance.translations shouldBe ("TODO")
        }

        // to test the property `views` - The number of times the listing has been viewed. This value is tabulated once per day and **only for active listings**, so the value is not real-time. If `0`, the listing has either not been viewed, not yet tabulated, was not active during the last tabulation or there was an error fetching the value. If a value is expected, call `getListing` to confirm the value.
        should("test views") {
            // uncomment below to test the property
