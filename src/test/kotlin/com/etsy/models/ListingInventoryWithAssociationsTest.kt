...
class ListingInventoryWithAssociationsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ListingInventoryWithAssociations
        //val modelInstance = ListingInventoryWithAssociations()
        ...
        // to test the property `listing` - An enumerated string that attaches a valid association. Default value is null.
        should("test listing") {
            // uncomment below to test the property
            //modelInstance.listing shouldBe ("TODO")
        }
