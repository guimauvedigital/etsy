...
open class ShopListingOfferingApi : ApiClient {
    ...
    open suspend fun getListingOffering(listingId: kotlin.Long, productId: kotlin.Long, productOfferingId: kotlin.Long, legacy: kotlin.Boolean? = null): HttpResponse<ListingInventoryProductOffering> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v3/application/listings/{listing_id}/products/{product_id}/offerings/{product_offering_id}".replace("{" + "listing_id" + "}", "$listingId").replace("{" + "product_id" + "}", "$productId").replace("{" + "product_offering_id" + "}", "$productOfferingId"),
