...
class TransactionReviewTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of TransactionReview
        //val modelInstance = TransactionReview()
        ...
        // to test the property `transactionId` - The ID of the ShopReceipt Transaction that the TransactionReview belongs to.
        should("test transactionId") {
            // uncomment below to test the property
            //modelInstance.transactionId shouldBe ("TODO")
        }

        // to test the property `buyerUserId` - The numeric ID of the user who was the buyer in this transaction. Note: This field may be absent, depending on the buyer's privacy settings.
