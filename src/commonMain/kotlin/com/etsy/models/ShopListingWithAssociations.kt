 ...
 * @param shippingProfile An array of data representing the shipping profile resource.
 * @param user Represents a single user of the site
 * @param shop A shop created by an Etsy user.
 * @param images Represents a list of listing image resources, each of which contains the reference URLs and metadata for an image
 * @param videos The single video associated with a listing.
 * @param inventory An enumerated string that attaches a valid association. Default value is null.
 * @param productionPartners Represents a list of production partners for a shop.
 * @param skus A list of SKU strings for the listing. SKUs will only appear if the requesting user owns the shop and a valid matching OAuth 2 token is provided. When requested without the token it will be an empty array.
 * @param translations A map of translations for the listing. Default value is a map of all supported languages keyed to null.
 * @param views The number of times the listing has been viewed. This value is tabulated once per day and **only for active listings**, so the value is not real-time. If `0`, the listing has either not been viewed, not yet tabulated, was not active during the last tabulation or there was an error fetching the value. If a value is expected, call `getListing` to confirm the value.
 */
@Serializable

data class ShopListingWithAssociations (
    ...
    @SerialName(value = "state") val state: ShopListingWithAssociations.State? = null,
    ...
    @SerialName(value = "listing_type") val listingType: ShopListingWithAssociations.ListingType? = null,
    ...
    @SerialName(value = "who_made") val whoMade: ShopListingWithAssociations.WhoMade? = null,
    ...
    @SerialName(value = "when_made") val whenMade: ShopListingWithAssociations.WhenMade? = null,
    ...
    @SerialName(value = "item_weight_unit") val itemWeightUnit: ShopListingWithAssociations.ItemWeightUnit? = null,
    ...
    @SerialName(value = "item_dimensions_unit") val itemDimensionsUnit: ShopListingWithAssociations.ItemDimensionsUnit? = null,
    ...
    @SerialName(value = "shipping_profile") val shippingProfile: ShopShippingProfile? = null,

    /* Represents a single user of the site */
    @SerialName(value = "user") val user: User? = null,

    /* A shop created by an Etsy user. */
    @SerialName(value = "shop") val shop: Shop? = null,

    /* Represents a list of listing image resources, each of which contains the reference URLs and metadata for an image */
    @SerialName(value = "images") val images: kotlin.collections.List<ListingImage>? = null,

    /* The single video associated with a listing. */
    @SerialName(value = "videos") val videos: kotlin.collections.List<ListingVideo>? = null,

    /* An enumerated string that attaches a valid association. Default value is null. */
    @SerialName(value = "inventory") val inventory: ListingInventory? = null,

    /* Represents a list of production partners for a shop. */
    @SerialName(value = "production_partners") val productionPartners: kotlin.collections.List<ShopProductionPartner>? = null,
    ...
    @SerialName(value = "skus") val skus: kotlin.collections.List<kotlin.String>? = null,

    /* A map of translations for the listing. Default value is a map of all supported languages keyed to null. */
    @SerialName(value = "translations") val translations: ListingTranslations? = null,

    /* The number of times the listing has been viewed. This value is tabulated once per day and **only for active listings**, so the value is not real-time. If `0`, the listing has either not been viewed, not yet tabulated, was not active during the last tabulation or there was an error fetching the value. If a value is expected, call `getListing` to confirm the value. */
    @SerialName(value = "views") val views: kotlin.Int? = null
