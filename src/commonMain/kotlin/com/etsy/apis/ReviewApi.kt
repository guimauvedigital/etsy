...
open class ReviewApi : ApiClient {
    ...
    open suspend fun getReviewsByListing(listingId: kotlin.Long, limit: kotlin.Int? = 25, offset: kotlin.Int? = 0, minCreated: kotlin.Int? = null, maxCreated: kotlin.Int? = null): HttpResponse<ListingReviews> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v3/application/listings/{listing_id}/reviews".replace("{" + "listing_id" + "}", "$listingId"),
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getReviewsByShop(shopId: kotlin.Long, limit: kotlin.Int? = 25, offset: kotlin.Int? = 0, minCreated: kotlin.Int? = null, maxCreated: kotlin.Int? = null): HttpResponse<TransactionReviews> {
        ...
        val localVariableConfig = RequestConfig<kotlin.Any?>(
            RequestMethod.GET,
            "/v3/application/shops/{shop_id}/reviews".replace("{" + "shop_id" + "}", "$shopId"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
        )
